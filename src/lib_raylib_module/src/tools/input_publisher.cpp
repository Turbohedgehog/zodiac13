...
constexpr std::string_view kInputSourceName = "z13::raylib::InputEventSource";
...
const std::unordered_map<SDL_Keycode, zkey::Keycode>& KeyMap() {
  static const std::unordered_map<SDL_Keycode, zkey::Keycode> map = {
      ...
      {SDLK_EXCLAIM, zkey::Keycode::KEY_EXCLAIM}, {SDLK_DBLAPOSTROPHE, zkey::Keycode::KEY_QUOTEDBL},
      {SDLK_HASH, zkey::Keycode::KEY_HASH}, {SDLK_PERCENT, zkey::Keycode::KEY_PERCENT},
      {SDLK_DOLLAR, zkey::Keycode::KEY_DOLLAR}, {SDLK_AMPERSAND, zkey::Keycode::KEY_AMPERSAND},
      {SDLK_LEFTPAREN, zkey::Keycode::KEY_LEFTPAREN}, {SDLK_RIGHTPAREN, zkey::Keycode::KEY_RIGHTPAREN},
      {SDLK_ASTERISK, zkey::Keycode::KEY_ASTERISK}, {SDLK_PLUS, zkey::Keycode::KEY_PLUS},
      {SDLK_COLON, zkey::Keycode::KEY_COLON}, {SDLK_LESS, zkey::Keycode::KEY_LESS},
      {SDLK_GREATER, zkey::Keycode::KEY_GREATER}, {SDLK_QUESTION, zkey::Keycode::KEY_QUESTION},
      {SDLK_AT, zkey::Keycode::KEY_AT}, {SDLK_CARET, zkey::Keycode::KEY_CARET},
      {SDLK_UNDERSCORE, zkey::Keycode::KEY_UNDERSCORE},
      {SDLK_CAPSLOCK, zkey::Keycode::KEY_CAPSLOCK}, {SDLK_PRINTSCREEN, zkey::Keycode::KEY_PRINTSCREEN},
      {SDLK_SCROLLLOCK, zkey::Keycode::KEY_SCROLLLOCK}, {SDLK_PAUSE, zkey::Keycode::KEY_PAUSE},
      {SDLK_NUMLOCKCLEAR, zkey::Keycode::KEY_NUMLOCKCLEAR},
      {SDLK_KP_DIVIDE, zkey::Keycode::KEY_KP_DIVIDE}, {SDLK_KP_MULTIPLY, zkey::Keycode::KEY_KP_MULTIPLY},
      {SDLK_KP_MINUS, zkey::Keycode::KEY_KP_MINUS}, {SDLK_KP_PLUS, zkey::Keycode::KEY_KP_PLUS},
      {SDLK_KP_ENTER, zkey::Keycode::KEY_KP_ENTER},
      {SDLK_KP_0, zkey::Keycode::KEY_KP_0}, {SDLK_KP_1, zkey::Keycode::KEY_KP_1},
      {SDLK_KP_2, zkey::Keycode::KEY_KP_2}, {SDLK_KP_3, zkey::Keycode::KEY_KP_3},
      {SDLK_KP_4, zkey::Keycode::KEY_KP_4}, {SDLK_KP_5, zkey::Keycode::KEY_KP_5},
      {SDLK_KP_6, zkey::Keycode::KEY_KP_6}, {SDLK_KP_7, zkey::Keycode::KEY_KP_7},
...
void ReadInput(flecs::world world, SdlPlatform& platform) {
  ...
  const Eigen::Vector2f mouse_pos = platform.MousePosition();

  const std::vector<SDL_Event>& events = platform.FrameEvents();
  ...
  frame.mouse_delta = platform.MouseDelta();
  frame.mouse_wheel = 0.f;
  for (const SDL_Event& event : events) {
    if (event.type == SDL_EVENT_MOUSE_WHEEL) {
      frame.mouse_wheel += event.wheel.y;
    }
  }
...
void RegisterSystems(flecs::world world) {
  ...
  world.system<const RaylibData, SdlPlatformData>("InputPublisher::ReadInput")
      ...
      .each([world](const RaylibData&, SdlPlatformData& platform_data) {
        ReadInput(world, *platform_data.platform);
      });
}

void CreateDefaults(flecs::world world) {
  world.entity(kInputSourceName.data());
  ...
  SdlPlatform& platform = *world.get_mut<SdlPlatformData>().platform;
  if (!platform.IsReady()) {
    return;
  }
  platform.SetRelativeMouse(!world.has<z13::gameplay::Pause>());
