...
struct Light {
  // Shader uniform location value raylib returns when a uniform isn't found.
  static constexpr int kLocNotFound = -1;
  ...
  int enabled_loc = kLocNotFound;
  int type_loc = kLocNotFound;
  int position_loc = kLocNotFound;
  int target_loc = kLocNotFound;
